...
## 内部RAM
内部的ram就是我们代码主要操作的地方，而且与上面不一样的是，这支持==8位的寻址==，这意味这这个内部的RAM打死最大也不会超过256Byte，这个RAM是定死256字节，接下来我们看看这256BYte色架构图：

![alt text](4d4e352d3ee57b84ea5375d33db92174~tplv-be4g95zd3a-image.jpeg)
